...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorCommunityInAppReview", path: "../../../node_modules/.pnpm/@capacitor-community+in-app-review@8.0.0_@capacitor+core@8.3.1/node_modules/@capacitor-community/in-app-review"),
