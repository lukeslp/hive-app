...
export const TemplateContextModal = ({
  ...
  const getPromptLabel = () => {
    switch (pendingTemplate.category) {
      case "product": return "What are you building?";
      case "creative": return "What's your creative vision?";
      case "business": return "What's your business idea?";
      case "research": return "What are you researching?";
      default: return "What problem are you solving?";
    }
  };
    ...
    >
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          <label className="text-sm font-medium text-card-foreground">{getPromptLabel()}</label>
          <textarea
          ...
          <p className="text-xs text-muted-foreground">
            More detail = more relevant brainstorming nodes. Include goals, constraints, or specific
            angles to explore.
          </p>
        </div>
